...
#    rawpy/tifffile for input formats). --originvision scoring is now the
#    native astro_native.originvision_score kernel (pure-Rust tract, built
#    below) -- no onnxruntime in the packaged app. The desktop app's own UI
