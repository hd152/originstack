...
| [src/stacking.py](src/stacking.py) | Sigma-clip, percentile, ESD, trimmed mean, Linear Fit Clipping, inverse-variance-weighted, drizzle, Lanczos, `run_stacking_phase` |
