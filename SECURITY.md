...
- **API keys**: `ASTROMETRY_API_KEY` and `ANTHROPIC_API_KEY` are read from environment variables. Do not commit these to version control or include them in config TOML files that are checked in.
